    ...
    <div class="card">
        ...
        <div class="card-body pt-0">
            ...
            <div class="row mb-5">
                ...
                <!--begin::Table-->
                <div id="kt_table_users_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer" style="padding-top: 20px">

                    <embed type="application/pdf" src="{{asset('theme2/gambar/raport.pdf')}}" width="100%" height="870px" />
