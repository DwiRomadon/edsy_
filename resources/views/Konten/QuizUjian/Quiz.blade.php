                    ...
                    <table id="tbfilter"  class=" display table table-striped table-bordered nowrap" style="width:100%">
                        ...
                        @foreach($mapel as $data)
                            <tr style="height: 40px">
                                ...
                                <td>
                                    <a style="background-color: deepskyblue; color: white" href="#" class="btn btn-light btn-active-light-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-flip="top-end">Quiz
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{route('tambahsoal' , ['id' => base64_encode($data->NIP.'>'.$data->idMapel.'>'.$data->Tahun.'>'.$data->Semester.'>'.$data->idkelompokkls.'>'.'Quiz' )])}}" class="menu-link px-3" >Quiz Baru</a>
                                        </div>
                                        <div class="menu-item px-3">
                                            <a href="{{route('lihatquiz', ['id' => base64_encode($data->NIP.'>'.$data->idMapel.'>'.$data->Tahun.'>'.$data->Semester.'>'.$data->idkelompokkls.'>'.'Quiz' )])}}" class="menu-link px-3" >Lihat Quiz</a>
                                        </div>
                                        <!--end::Menu item-->
                                    </div>
                                    <!--end::Menu-->
